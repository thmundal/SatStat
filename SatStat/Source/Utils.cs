...
namespace SatStat.Utils
{
    /// <summary>
    /// Static class containing logic for casting to different data types identifying the target type trough a string
    /// </summary>
    public static class Cast
    {
        /// <summary>
        /// Cast a value to a specific type using a string as type description
        /// </summary>
        /// <param name="o">Object to cast</param>
        /// <param name="type">The type to cast to described by a string</param>
